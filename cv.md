...
- Postdoctoral research training in psychophysics and auditory neuroscience, [Laboratory for Auditory Brain Science & Neuroengineering](http://depts.washington.edu/labsn/) (_[LABS]<sup>N</sup>_, PI: [Adrian KC Lee](http://faculty.washington.edu/akclee/), 2013-2018).
...
- {% reference MoranEtAl2012-language %}  ([preprint](http://hdl.handle.net/1773/25269) | [Data and R script (.zip)](../pubs/MoranMcCloyWright2012-DataAndScript.zip))
...
- {% reference McCloy2013-er %}  ([published version](http://hdl.handle.net/1773/25273))
- {% reference McCloy2012-phonR %}  ([original PDF](../pubs/McCloy2012_phonR.pdf) | [updated web version](http://drammock.github.io/phonR/))
- {% reference McCloy2010-nwlcProc %}  ([published version](http://hdl.handle.net/1773/25270))
...
- **Contributor**: [MNE-Python](https://mne.tools) analysis and visualization software for EEG & MEG ([repo](https://github.com/mne-tools/mne-python)).

## Other scientific activities
- MNE-Python code sprint (2019)
...
- “Statistical models for psychophysics: ANOVA vs. mixed models.”  _[LABS]<sup>N</sup>_ (2014).
