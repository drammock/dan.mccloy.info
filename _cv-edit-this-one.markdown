...
- Introduction to Linguistics (LING 200): Teaching assistant for four sections (2008–2009).
- New Majors Seminar (PHIL 199): Developed and co-led a proseminar for incoming Philosophy students to introduce the breadth of the field and the research of UW faculty (2001, 2002).
...
- Linguistics Tutor, UW Center for Learning and Undergraduate Enrichment (2009).
- Teaching Assistant, Department of Linguistics (2008–2009).
...
- Computational (in decreasing order of facility): R, Python, Praat, LaTeX, Bash, HTML, CSS, CSL, MATLAB, Actionscript 3 (Flash), BST.
